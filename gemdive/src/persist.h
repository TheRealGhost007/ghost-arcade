...
typedef struct {
    ...
    bool audioEnabled;
    bool scanlines;    /* CRT scanline overlay on the cave */
} Settings;
...
/* Loads from $XDG_CONFIG_HOME/gemdive/config.ini, falling back to
...
/* Loads from $XDG_DATA_HOME/gemdive/save.dat. Returns true if a file
 * was found and read. */
