...
typedef struct {
    ...
    bool audioEnabled;
    bool scanlines;    /* CRT scanline overlay on the maze */
} Settings;
...
/* Loads from $XDG_CONFIG_HOME/lanehop/config.ini, falling back to
...
/* Loads from $XDG_DATA_HOME/lanehop/save.dat. Returns true if a file
 * was found and read. */
