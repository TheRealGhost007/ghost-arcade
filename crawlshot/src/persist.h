...
typedef struct {
    ...
    bool mouseControl; /* steer the shooter with the mouse, click to fire */
} Settings;
...
/* Loads from $XDG_CONFIG_HOME/crawlshot/config.ini, falling back to
...
/* Loads from $XDG_DATA_HOME/crawlshot/save.dat. Returns true if a file
 * was found and read. */
