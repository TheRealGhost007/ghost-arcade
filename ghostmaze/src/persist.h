...
/* Loads from $XDG_CONFIG_HOME/ghostmaze/config.ini, falling back to
...
/* Loads from $XDG_DATA_HOME/ghostmaze/save.dat. Returns true if a file
 * was found and read. */
